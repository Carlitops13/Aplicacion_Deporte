...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnAgregar->setGeometry(QRect(150, 90, 75, 24));
        btnMostrar = new QPushButton(centralwidget);
        btnMostrar->setObjectName("btnMostrar");
        btnMostrar->setGeometry(QRect(260, 90, 75, 24));
        tblDeportistas = new QTableWidget(centralwidget);
        tblDeportistas->setObjectName("tblDeportistas");
        tblDeportistas->setGeometry(QRect(390, 90, 256, 192));
